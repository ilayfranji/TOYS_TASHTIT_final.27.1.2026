...
public class AlertDialogHelper {
    ...
    USAGE:
        ...
        AlertDialogHelper.alert(
            ...
            "Save",           // positive btnCancel
            "Don't Save",     // negative btnCancel
            "Cancel",         // neutral btnCancel
        ...
        AlertDialogHelper.alert(
            ...
            "Yes",            // positive btnCancel
            "No",             // negative btnCancel
            null,             // no neutral btnCancel
            () -> deleteItem(),               // positive action
            () -> cancelDeletion(),           // negative action
            null                              // no neutral action
        );

        // Example 3: Dialog with only positive btnCancel and custom text
        AlertDialogHelper.alert(
            context,
            "Success",
            ...
            "Great!",         // positive btnCancel
            null,             // no negative btnCancel
            null,             // no neutral btnCancel
