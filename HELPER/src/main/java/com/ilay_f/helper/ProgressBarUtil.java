...
public class ProgressBarUtil {
    ...
    /**
     * This function shows a spinnerCategory Progress bar default color without message
     *
    ...
    /**
     * This function shows a spinnerCategory Progress bar with specified color without message
     *
     * @param context       context usually this
     * @param view          the view to display the progress bar
    ...
    /**
     * This function shows a spinnerCategory Progress bar default color
     *
     * @param context       context usually this
     * @param view          the view to display the progress bar
    ...
    /**
     * This function shows a spinnerCategory Progress bar with specified color
     *
     * @param context       context usually this
     * @param view          the view to display the progress bar
     * @param message       optional message
     ...
     * @param view          the view to display the progress bar
     * @param message       optional message
     * @param horizontal    true - horizontal, false - spinnerCategory
     * @param color         progress bar and message color
     * @return Progress Bar
     */
